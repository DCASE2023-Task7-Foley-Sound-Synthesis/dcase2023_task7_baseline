...
class HiFiGanWrapper:
    def __init__(self, generator_pretrain_name: str, config_path: str):
        self.hifi_gan_generator: Generator
        self.generator_pretrain_path: str = generator_pretrain_name
    ...
    def load_hifi_gan(self):
        ...
        self.hifi_gan_generator = Generator(AttrDict(json_config))
        ...
        self.hifi_gan_generator = self.hifi_gan_generator.cuda()
        self.hifi_gan_generator.eval()
        self.hifi_gan_generator.remove_weight_norm()

    def generate_audio_by_hifi_gan(self, input_feature):
        final_shape_len = 3
